...
<div>
            ...
            <b-row>
                <b-col cols="12" md="4">
                    <b-form-group label="Usuario" label-for="username">
                        <b-form-input id="username" v-model="usuario" />
                    </b-form-group>
                </b-col>
                <b-col cols="12" md="4">
                    <b-form-group label="Nombre" label-for="nombree">
                        <b-form-input id="nombree" v-model="nombre" />
                    </b-form-group>
                </b-col>
                <b-col cols="12" md="4">
                    <b-form-group label="Apellido" label-for="apellidoo">
                        <b-form-input id="apellidoo" v-model="apellido" />
                    </b-form-group>
                </b-col>
                <b-col cols="12" md="4">
                    <b-form-group label="Email" label-for="mail">
                        <b-form-input id="mail" v-model="email" />
                    </b-form-group>
                </b-col>
                <b-col cols="12" md="4">
                ...
                <b-col cols="12" md="4">
                    <b-form-group label="Ciudad" label-for="ciudadd">
                        <b-form-input id="ciudadd" v-model="ciudad" />
                    </b-form-group>
                </b-col>
                <b-col cols="12" md="4">
                    <b-form-group label="Dirección" label-for="direc">
                        <b-form-input id="direc" v-model="direccion" />
                    </b-form-group>
                </b-col>
                <b-col cols="12" md="4">
                ...
                <b-col cols="12" md="4">
                    <b-form-group label="Código Postal" label-for="zip">
                        <b-form-input id="zip" v-model="cp" />
                    </b-form-group>
                </b-col>
            </b-row>
        </b-form>
    ...
    <b-button  v-ripple.400="'rgba(113, 102, 240, 0.15)'"
        @click="makeToast('primary')" variant="primary" class="mb-1 mb-sm-0 mr-0 mr-sm-1" v-on:click="updateValue">
        Guardar Cambios
    </b-button>
