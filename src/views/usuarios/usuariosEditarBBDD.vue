<template>
<div>
    <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" :to="{ name: 'users-usuarios-bbdd'}" variant="primary" class="btn-icon" style="float: right; position: static;">
        Volver
    </b-button>
    <div>
        <b-overlay :show="show" rounded="sm">
            ...
            <!-- Action Buttons -->
            <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" variant="primary" class="mb-1 mb-sm-0 mr-0 mr-sm-1" @click="actualizarRegistro" :click="completado">
                Guardar Cambios
            </b-button>
        </b-overlay>
    </div>
